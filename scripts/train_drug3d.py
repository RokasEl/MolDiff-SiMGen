...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="configs/train/train_MolDiff.yml")
    ...
    print(
        "Num of trainable parameters is",
    ...
    def train(it):
        ...
        with torch.autocast(
            device_type="cuda", dtype=torch.float16, enabled=config.train.use_amp
        ):
